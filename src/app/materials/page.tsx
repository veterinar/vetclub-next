...
export default function MaterialsPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200">Ветеринарные материалы</h2>
      ...
      {referenceGroup.length > 0 && (
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200">Справочник</h2>
          <div className="grid gap-6">
      ...
      {guidesGroup.length > 0 && (
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4 pb-2 border-b border-gray-200">Руководства</h2>
