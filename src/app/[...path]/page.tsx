      ...
      return (
        <div>
          <nav className="text-sm text-gray-500 mb-4">
            <a href="/" className="hover:text-emerald-700">← Главная</a>
          </nav>
          ...
          <div className="space-y-3">
            {articles.map((article) => (
              <Link
                ...
                className="block bg-white p-4 rounded border border-gray-200 hover:border-emerald-300 hover:shadow-sm transition-all"
              >
      ...
      <div className="py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          <form className="flex gap-2">
            ...
            />
            <button type="submit" className="px-6 py-2 bg-emerald-700 text-white rounded hover:bg-emerald-800">
              Поиск
            </button>
          </form>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 max-w-lg">
          <form className="space-y-4">
            <div>
              ...
              <input type="text" className="w-full px-3 py-2 border border-gray-200 rounded" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
              <input type="email" className="w-full px-3 py-2 border border-gray-200 rounded" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Сообщение</label>
              <textarea rows={4} className="w-full px-3 py-2 border border-gray-200 rounded" />
            </div>
            <button type="submit" className="px-6 py-2 bg-emerald-700 text-white rounded hover:bg-emerald-800">
              Отправить
            </button>
