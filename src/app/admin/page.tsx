  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/admin/articles/new" className="inline-flex items-center gap-2 px-4 py-2 bg-[#2e7d32] text-white rounded-lg hover:bg-[#1b5e20] font-medium transition-colors">
          <PlusCircle size={18} />Новая статья
        </Link>
      </div>
